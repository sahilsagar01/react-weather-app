...
<div id="carouselExampleControls" class="carousel slide" data-ride="false">
  <div class="carousel-inner">
    ...
    <h1>Monsoon <small class="text-muted">jun-sep</small></h1>
      <img className="carouselImg" src="https://photos.demandstudios.com/getty/article/176/161/547033564.jpg" alt="..." />
      <h3 className="paragraph">
      <small className="text-muted ">
      The wet season (sometimes called the rainy season or monsoon season) is the time of year when most of a region's average annual rainfall occurs.[1] Generally, the season lasts at least a month.[2] The term green season is also sometimes used as a euphemism by tourist authorities.[3] Areas with wet seasons are dispersed across portions of the tropics and subtropics.[4].
    ...
    <div class="carousel-item">
    <h1>Autumn <small class="text-muted">oct-nov</small></h1>
      <img className="carouselImg" src="https://free4kwallpapers.com/uploads/originals/2015/09/26/autumn-season-wallpaper.jpg" alt="..." />
      <h3 className="paragraph">
      <small className="text-muted">
    ...
    <div class="carousel-item">
    <h1>Winter <small class="text-muted">dec-feb</small></h1>
      <img className="carouselImg" src="https://wallpapers.com/images/hd/winter-season-orange-sky-p7qs0gvru2zlexon.jpg" alt="..." />
      <h3 className="paragraph">
      <small className="text-muted ">
  ...
  <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleControls" data-bs-slide="next">
    ...
    <span class="visually-hidden btn-warning">Next</span>
  </button>
</div>
</section>
</div>
